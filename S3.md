...
- ACL enabled ( bucket owner prefered) - use bucket-owner-full-control ACL - New objects
- ACL disbaled (object writer) - object writer has full control and grant permission to others - New objects
